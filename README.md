...
* I'm storing in [/prompts](/prompts) all tasks/bugs. I asked claude code to generate release notes for me and created [RELEASENOTES.md](/RELEASENOTES.md) which is pretty good.
